...
### Changed
- Block artefacts now normalize `iso_week_range` to the covering Macro phase and emit a warning when inputs disagree.
- Streamlit UI system log captures block-range normalization warnings from the guarded store.
