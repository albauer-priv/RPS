...
| Phase | `phase_planning` | Planning | Convert season governance into phase guardrails, structure, and preview | `phase_context_read`, `phase_guardrail_band_draft`, `phase_execution_rules_draft`, `phase_structure_draft`, `phase_cadence_recovery_draft`, `phase_intensity_distribution_draft`, `phase_event_integration_draft`, `phase_preview_draft`, `phase_bundle_finalize` | internal `PhaseBundle` |
...
| Season | `season_planning` | `macrocycle_architect` | Reverse planner | `season_macrocycle_draft` | build the season macrocycle backward from priority events | `skills/season/macrocycle-architecture` |
...
| Season | `season_planning` | `season_plan_manager` | Planning synthesizer | `season_plan_finalize` | consolidate all season drafts into one internal `SeasonPlanBundle` | `skills/season/plan-synthesis` |
...
| Phase | `phase_planning` | `phase_bundle_manager` | Planning synthesizer | `phase_bundle_finalize` | consolidate all phase drafts into one internal `PhaseBundle` | `skills/phase/bundle-synthesis` |
