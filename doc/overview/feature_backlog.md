...
- [ ] FEAT_seasonal_availability — extend AVAILABILITY schema with optional `seasonal_context` block (outdoor/indoor months, indoor max session hours); add Streamlit form section; inject into season orchestrator context; update scenario and macrocycle skills to describe winter/indoor phases with appropriate load ceiling and intensity density.
