...
- [x] FEAT_contract_validation_assembly_fix — fix synthetic Season contract assembly, correct Week payload-vs-authority posture validation, and add regression coverage for code-owned contract-assembly failures.
