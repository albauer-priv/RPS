...
* **Related:** doc/ui/pages/athlete_profile.md
...
* [ ] `doc/architecture/subsystems/data_pipeline.md` — add historical baseline step.
* [ ] `doc/ui/pages/athlete_profile.md` — historic data source and refresh behavior.
