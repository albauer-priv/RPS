...
* [ ] [doc/overview/artefact_flow.md](../../overview/artefact_flow.md) — update runtime/spec root references.
* [ ] [doc/architecture/workspace.md](../../architecture/workspace.md) — workspace root + run store paths.
* [ ] [doc/runbooks/validation.md](../../runbooks/validation.md) — updated paths for scripts/tools.
