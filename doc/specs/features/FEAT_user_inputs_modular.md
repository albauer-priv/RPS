...
* [x] `doc/ui/pages/athlete_profile.md` — new nav order + new pages.
* [x] `doc/architecture/workspace.md` — new inputs in `inputs/`.
* [x] `doc/overview/artefact_flow.md` — updated inputs.
