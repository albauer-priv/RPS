...
* UI: [doc/ui/pages/performance_data_metrics.md](../../ui/pages/performance_data_metrics.md)
* Architecture: [doc/architecture/subsystems/data_pipeline.md](../../architecture/subsystems/data_pipeline.md)
* Feature cache: [doc/specs/features/FEAT_parquet_cache.md](FEAT_parquet_cache.md))
