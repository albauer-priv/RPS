...
ARTIFACT_PATHS: dict[ArtifactType, ArtifactPathConfig] = {
    ...
    ArtifactType.SEASON_PLAN: ArtifactPathConfig("data/plans/macro", "season_plan"),
    ArtifactType.MACRO_MESO_FEED_FORWARD: ArtifactPathConfig("data/plans/macro", "macro_meso_feed_forward"),
    ArtifactType.PHASE_GUARDRAILS: ArtifactPathConfig("data/plans/meso", "phase_guardrails"),
    ArtifactType.PHASE_STRUCTURE: ArtifactPathConfig("data/plans/meso", "phase_structure"),
    ArtifactType.PHASE_PREVIEW: ArtifactPathConfig("data/plans/meso", "phase_preview"),
    ...
    ArtifactType.WEEK_PLAN: ArtifactPathConfig("data/plans/micro", "week_plan"),
