...
PHASE_SEMANTIC_PROFILES: dict[str, PhaseSemanticProfile] = {
    ...
    "vo2_base": PhaseSemanticProfile(
        phase_type="BASE",
        max_allowed_intensity_domains=("RECOVERY", "ENDURANCE", "TEMPO", "VO2MAX"),
        optional_intensity_domains=("TEMPO",),
        forbidden_intensity_domains=("SWEET_SPOT", "THRESHOLD"),
        allowed_load_modalities=("NONE", "K3"),
        methodology_family="aerobic_ceiling_base",
        threshold_role="forbidden",
        event_load_policy="no_event_load_exception",
        taper_policy="not_applicable",
        writer_semantic_notes=(
            "Describe this phase as ceiling-raising Base work — VO2MAX intervals on a protected ENDURANCE base.",
            "Do not imply threshold or sweet spot progression; this is an early ceiling-building phase before VLamax work.",
        ),
    ),
