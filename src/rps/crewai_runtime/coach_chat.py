        ...
        return _run_structured_task(
            ...
            description="\n".join(
                [
                    ...
                    "",
                    "Provide direct coaching advice only and keep preview creation in the dedicated preview task.",
                    ...
                    "If the answer needs a source-backed rationale, use retrieved curated durability evidence or available primary-source verification results as justification only.",
                    "Reference priority is the canonical local evidence library first, generated core table second, and generated applied table third. Prefer peer-reviewed sources before practitioner media, cite only verified sources, and omit uncertain locators instead of inventing them.",
                ]
            ),
        ...
        return _run_structured_task(
            ...
            description="\n".join(
                [
                    ...
                    "Resolve the pending state only; keep new preview creation in the preview task.",
                ]
            ),
        ...
        final_reply = _run_text_task(
            ...
            description="\n".join(
                [
                    ...
                    "Answer simple advisory questions with compact coach prose; use checklists or step plans only when the user explicitly asked for that format.",
                    "Use domain calculations, IF targets, thresholds, citations, and source claims only when they are present in the specialist result or injected context.",
        ...
        repaired_reply = _run_text_task(
            ...
            description="\n".join(
                [
                    ...
                    payload.model_dump_json(indent=2),
                    "",
                    "Previous final reply used task-runner style that needs repair:",
                    ", ".join(style_issues),
                    "",
                    ...
                    "Use natural coach language and reserve DONE, READY, OUTPUT, Was:, Prüfen:, and Bedingung: labels for internal task artifacts only.",
                    "Use a step-by-step action checklist only when the original user explicitly asked for one.",
                    "Use domain calculations, IF targets, thresholds, citations, and source claims only when they are present in the specialist result or injected context.",
                    "End with one concrete next safe action.",
                    "",
