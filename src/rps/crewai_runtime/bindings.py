...
def output_model_for_kind(output_kind: str) -> type[Any]:
    ...
    registry: dict[str, type[Any]] = {
        ...
        "season_phase_blueprint_draft": SeasonPhaseBlueprintDraftOutputModel,
        "season_plan_audit": SeasonPlanAuditModel,
        "season_plan_draft_bundle": SeasonPlanDraftBundleModel,
        "season_plan_manager_synthesis": SeasonPlanManagerSynthesisModel,
        ...
        "phase_bundle_draft": PhaseDraftBundleModel,
        "phase_bundle_manager_synthesis": PhaseBundleManagerSynthesisModel,
