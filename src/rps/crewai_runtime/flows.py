...
def run_season_flow(
    *,
    ...
    def route(self: Any, selected_action: str) -> str:
        return selected_action

    def run_scenarios(self: Any) -> JsonMap:
        try:
    ...
    def run_selection(self: Any) -> JsonMap:
        try:
            self.state.result = run_agent_multi_output(
                runtime_for(agent_name),
                agent_name=agent_name,
...
def run_feed_forward_flow(
    *,
    ...
    def run_season_phase(self: Any, _report_result: JsonMap) -> JsonMap:
    ...
    def run_phase(self: Any, _season_phase_result: JsonMap) -> JsonMap:
...
def run_coach_flow(
    *,
    ...
    def route_turn(self: Any, _message: str) -> str:
    ...
    def run_chat_turn(self: Any) -> str:
        try:
